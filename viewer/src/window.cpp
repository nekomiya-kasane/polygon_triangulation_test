...
void ResolveGeneration()
{
  ...
  states.generateRandomSize = GuiSliderBar(RealRect(10, screenHeight - 120, 100, 20), NULL, " Point count",
                                           states.generateRandomSize, 0, 200);
}
...
int main()
{
  ...
  points = {{{4, 0}, {9, 3}, {0, 4}, {-2, 0}, {5, 2}, {3, 5}, {3, -1}, {-2, 6}, {3, -2}, {6, 8}}};
  points = {{{0.050211, 4.75509},    {-0.866192, 4.1941},  {-1.09727, 3.3946},  {4.78303, -1.09802},
             {8.82659, 4.69077},     {-0.244161, 6.79237}, {0.309313, 3.87117}, {1.53542, 4.63047},
             {6.65528, 2.90399},     {9.71873, 3.52344},   {6.45619, 4.14603},  {8.60161, 9.13543},
             {-0.560268, 0.0737834}, {7.19898, -0.405021}, {9.49813, 4.90058},  {0.281211, 3.47505},
             {4.4732, 7.26256},      {3.63074, 4.71875},   {5.4626, 6.53438},   {3.65432, 5.58291}}};
