                                             ...
                                             bool checkRight)
{
  ...
  if (checkLeft && Finite(leftSegmentID))
  {
    ...
    if (LLowID != RLowID && LHighID != LHighID)
    {
